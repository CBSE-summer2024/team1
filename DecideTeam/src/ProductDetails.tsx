...
import { EVENTS,fetchProductById,ROUTES} from 'Shared/dist/index';
  ...
  return (
    <div className="min-h-screen">
      <div className="breadcrumbs text-sm">
        <ul>
          <li>
            <button onClick={() => handleNavigation(ROUTES.HOME)}>Home</button>
          </li>
          <li>
            <button onClick={() => handleNavigation(ROUTES.PRODUCTS)}>Products</button>
          </li>
